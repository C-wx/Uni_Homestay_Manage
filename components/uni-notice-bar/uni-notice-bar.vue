<template>
	<view v-if="show" class="uni-noticebar" :style="{ backgroundColor: backgroundColor }" @click="onClick" style="border-radius: 16upx;">
		<!-- #ifdef MP-ALIPAY -->
		<view v-if="showClose === true || showClose === 'true'" class="uni-noticebar-close" @click="close">
			<text class="cuIcon-roundclosefill" style="font-size: 24upx;"></text>
		</view>
		<view v-if="showIcon === true || showIcon === 'true'" class="uni-noticebar-icon">
			<text class="cuIcon-notification" style="font-size: 28upx;"></text>
		</view>
		<!-- #endif -->
		<text class="cuIcon-notification" style="font-size: 30upx;color: #de8c17;"></text>
